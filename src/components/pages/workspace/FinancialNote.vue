<template>
  ...
  <el-table height="80vh" :data="dataSource">
    <el-table-column label="业务" prop="date" align="middle" />
    <el-table-column label="企业名称" prop="date" align="middle" />
    <el-table-column label="发票信息" align="middle">
      <el-table-column label="种类" prop="date" align="middle" />
      <el-table-column label="日期" prop="date" align="middle" />
      <el-table-column label="金额" prop="date" align="middle" />
      <el-table-column label="差额" prop="date" align="middle" />
      <el-table-column label="手续费" prop="date" align="middle" />
    </el-table-column>
    ...
    <el-table-column label="劳务费" align="middle">
      <el-table-column label="支付日期" prop="date" align="middle" />
      <el-table-column label="支付金额" prop="date" align="middle" />
    </el-table-column>
    <el-table-column label="备注" prop="date" align="middle" />
